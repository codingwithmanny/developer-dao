 ...
 *
 */
describe('Mint Page - Expected Negative Interactions', () => {
  /**
   *
   */
  it('Shows 404 for an unknown language', () => {
    // Setup
    cy.visit(`/${LANGUAGES.UNKNOWN}/mint`, { failOnStatusCode: false });
    ...
    // - Location
    cy.location('pathname').should('eq', `/${LANGUAGES.UNKNOWN}/mint`);
 ...
 *
 */
describe('Mint Page - Expected Positive Interactions', () => {
  /**
   *
   */
